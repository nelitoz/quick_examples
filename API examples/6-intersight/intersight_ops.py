...
AUTH = IntersightAuth(
    secret_key_filename='/home/dacasti2/intersight-rest-api/key/SecretKey.txt',
    api_key_id='60b822bc7564612d330f0d3d/60b822bc7564612d330f0d42/60b823947564612d330f1691'
    )
...
if __name__ == "__main__":
    ...
    for operation in OPERATIONS:
        ...
        if operation['request_process']:
            ...
            with open("results.txt", "a") as fhand:
